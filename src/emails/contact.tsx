...
export const Contact = ({ senderEmail, message, enquiry }: ContactEmailProps) => (
  <Html>
    <Head />
    <Preview>You have received an inquiry from someone!</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={section}>
          ...
          <Text style={text}>Someone recently left a message on your website.</Text>
          <Hr></Hr>
          <Text style={text}>
